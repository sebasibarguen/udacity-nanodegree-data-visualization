...
ggplot(df.location, aes(lon, lat)) + geom_point() + xlab("Longitude") + ylab("Lattitue")  + ggtitle("World long-lat mapping")
...
```{r}
ggpairs(subset(df.language, select=c(n, open_issues, forks, size, age)))
```
